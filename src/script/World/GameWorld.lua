...
function CGameWorld:MessageProc(nMsgID, pData, nLen)
    ...
    -- UI功能
    if MSGFUNC.UI ==  funcId then               
        CUIManager:GetInstance():MessageProc(nMsgID, pData, nLen)
        
    -- 连接服务器成功
    elseif nMsgID == MSGID.CC_CONNECT_SUCCESS then  
